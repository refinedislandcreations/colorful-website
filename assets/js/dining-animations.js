// assets/js/dining-animations.js
...
function initAnimations() {
  ...
  gsap.fromTo(
    ...
    { opacity: 0, x: -50 },
    {
      ...
      x: 0,
      duration: 1,
      scrollTrigger: { trigger: "#restaurant-1", start: "top 80%" },
    }
  );
  ...
  gsap.fromTo(
    ...
    { opacity: 0, x: 50 },
    {
      ...
      x: 0,
      duration: 1,
      scrollTrigger: { trigger: "#restaurant-2", start: "top 80%" },
    }
  );
  ...
  gsap.fromTo(
    ...
    { opacity: 0, y: 30 },
    {
      ...
      duration: 1,
      scrollTrigger: {
        trigger: "#private-dining-heading",
        start: "top 80%",
      },
    }
  );
  ...
  gsap.fromTo(
    ...
    { opacity: 0, y: 30 },
    {
      ...
      y: 0,
      duration: 0.8,
      scrollTrigger: { trigger: "#event-cta", start: "top 80%" },
    }
  );
